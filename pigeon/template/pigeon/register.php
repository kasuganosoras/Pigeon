...
$temp_user  = (isset($_POST['username']) && is_string($_POST['username']) && preg_match("/^[A-Za-z0-9\_\-]+$/", $_POST['username'])) ? $_POST['username'] : "";
$temp_email = (isset($_POST['email']) && is_string($_POST['email']) && preg_match("/^[a-zA-Z0-9]+([-_.][a-zA-Z0-9]+)*@([a-zA-Z0-9]+[-.])+([a-z]{2,5})$/ims", $_POST['email'])) ? $_POST['email'] : "";
?>
					<center>
