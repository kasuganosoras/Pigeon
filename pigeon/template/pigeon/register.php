							...
							<div class="col-sm-6">
								...
								<form method="POST">
									...
									<div class="input-group">
										...
										<input type="text" placeholder="账号" value="<?php echo htmlspecialchars($tempUser); ?>" name="username" class="form-control" required style="box-shadow: none;height: 42px;border-radius: 0px 6px 0px 0px;">
									</div>
									<div class="input-group">
										<span class="input-group-addon" style="border-top: 0px;border-radius: 0px;"><i class="fa fa-envelope-o" style="width: 16px;"></i></span>
										<input type="email" placeholder="邮箱" value="<?php echo htmlspecialchars($tempMail); ?>" name="email" class="form-control" required style="box-shadow: none;height: 41px;border-radius: 0px;border-top: 0px;">
									</div>
									<div class="input-group">
